...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,5.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[4] = float4(1.000000,1.000000,1.000000,0.500000);//(Unknown)
